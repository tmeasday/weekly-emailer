# Lifted from https://github.com/harvesthq/harvest_api_samples/blob/master/harvest_api_sample.rb
...
class Harvest
  ...
  def headers
    {
      # Declare that you expect response in JSON after a _successful_
      # response.
